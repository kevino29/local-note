#pragma checksum "C:\Users\varax\source\repos\LocalNote\LocalNote\MainPage.xaml" "{8829d00f-11b8-4213-878b-770e8597ac16}" "325E1FE333D8D49D768C83A5EC4182A5D3180A0586517A7278B763C22B2DA277"
//------------------------------------------------------------------------------
// <auto-generated>
            ...
            IMainPage_Bindings
        {
            ...
            public void Connect(int connectionId, global::System.Object target)
            {
                switch(connectionId)
                {
                    case 14: // MainPage.xaml line 65
                        ...
                        this.bindingsTracking.RegisterTwoWayListener_14((this.obj14.Target as global::Windows.UI.Xaml.Controls.TextBlock));
                        break;
                    default:
                        break;
                }
            ...
            private void UpdateTwoWay_14_Text()
            {
                if (this.initialized)
                {
                    ...
                    {
                        this.dataRoot.Title = (this.obj14.Target as global::Windows.UI.Xaml.Controls.TextBlock).Text;
                    }
                }
            }
            ...
            private class MainPage_obj14_BindingsTracking
            {
                ...
                {
                    MainPage_obj14_Bindings bindings = TryGetBindingObject();
                    if (bindings != null)
                    {
            ...
            private void UpdateTwoWay_10_Text()
            {
                if (this.initialized)
                {
                    if (this.dataRoot != null)
                    {
                        if (this.dataRoot.NoteViewModel != null)
                        {
                            this.dataRoot.NoteViewModel.Filter = this.obj10.Text;
                        }
                    }
                }
            }
            private void UpdateTwoWay_11_SelectedItem()
            {
                if (this.initialized)
                {
                    if (this.dataRoot != null)
                    {
                        if (this.dataRoot.NoteViewModel != null)
                        {
                            this.dataRoot.NoteViewModel.SelectedNote = (global::LocalNote.Models.NoteModel)this.obj11.SelectedItem;
                        }
                    }
                }
            }
            private void UpdateTwoWay_12_Text()
            {
                if (this.initialized)
                {
                    if (this.dataRoot != null)
                    {
                        if (this.dataRoot.NoteViewModel != null)
                        {
                            this.dataRoot.NoteViewModel.NoteContent = this.obj12.Text;
                        }
                    }
                }
            }
            private void UpdateTwoWay_12_IsReadOnly()
            {
                if (this.initialized)
                {
                    if (this.dataRoot != null)
                    {
                        if (this.dataRoot.NoteViewModel != null)
                        {
                            this.dataRoot.NoteViewModel.ReadOnly = this.obj12.IsReadOnly;
                        }
                    }
                }
            }
