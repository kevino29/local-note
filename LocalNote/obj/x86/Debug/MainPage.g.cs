#pragma checksum "C:\Users\Kevin\source\repos\LocalNote\LocalNote\MainPage.xaml" "{8829d00f-11b8-4213-878b-770e8597ac16}" "2EA6ADDCDCFF6EE4EA92A99CEE5527BA43B8D77DC08F4EBEBF100E294F143213"
//------------------------------------------------------------------------------
// <auto-generated>
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
            ...
            IMainPage_Bindings
        {
            ...
            public void Disable(int lineNumber, int columnNumber)
            {
                ...
                else if (lineNumber == 20 && columnNumber == 47)
                {
            ...
            private void UpdateTwoWay_6_SelectedItem()
            {
                if (this.initialized)
                {
                    if (this.dataRoot != null)
                    {
                        if (this.dataRoot.NoteViewModel != null)
                        {
                            this.dataRoot.NoteViewModel.SelectedNote = (global::LocalNote.Models.NoteModel)this.obj6.SelectedItem;
                        }
                    }
                }
            }
            private void UpdateTwoWay_7_Text()
            {
                if (this.initialized)
                {
                    if (this.dataRoot != null)
                    {
                        if (this.dataRoot.NoteViewModel != null)
                        {
                            this.dataRoot.NoteViewModel.NoteContent = this.obj7.Text;
                        }
                    }
                }
            }
